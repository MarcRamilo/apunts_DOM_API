const BASE_URL = "https://swapi.info/api/"; //Definim la URL

export async function getMovieCount() { // Funció async
  const res = await fetch("https://swapi.dev/api/films/"); // Fem una petició fetch
  const data = await res.json(); //Parsejem amb json
  return data.count; // Fem un count
}
